							...
							<div class="doctor-widget">
								<div class="doc-info-left">
									<div class="doctor-img">
										...
										?>
										<img src="<?= $doctor["image_path"]==null? "assets/img/default.png" : $doctor["image_path"] ?>" class="img-fluid" alt="User Image">
									</div>
									<div class="doc-info-cont">
										<h4 class="doc-name">Dr. <?= $doctor["firstname"]. " ". $doctor["lastname"] ?></h4>
										
										<div class="clinic-details">
											<p class="doc-location"><i class="fas fa-map-marker-alt"></i> <?= $doctor["country"]==null? "" : $doctor["country"] ?></p>
								...
								<div class="doc-info-right">
									...
									<div class="clinic-booking">
										<a class="apt-btn" href="booking.php?id=<?= $id?>">Book Appointment</a>
									</div>
								</div>
							</div>
						</div>
									...
									<div class="row">
										<div class="col-md-12 col-lg-9">
											...
											<div class="widget about-widget">
												...
												<p><?= $doctor["biography"]==null? "" : $doctor["biography"] ?></p>
											</div>
											<!-- /About Details -->
